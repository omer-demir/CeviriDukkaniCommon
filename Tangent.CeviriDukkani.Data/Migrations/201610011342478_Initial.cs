namespace Tangent.CeviriDukkani.Data.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        {
            CreateTable(
                "System.AccountRegistration",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        UserId = c.Int(nullable: false),
                        CurrentStep = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        IsApplicableForCalculation = c.Boolean(nullable: false),
                        Active = c.Boolean(nullable: false),
                        CreatedAt = c.DateTime(nullable: false),
                        CreatedBy = c.Int(nullable: false),
                        UpdatedAt = c.DateTime(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TranslatingOrderId = c.Int(nullable: false),
                        TranslationOperationId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("Order.TranslatingOrder", t => t.TranslatingOrderId,cascadeDelete: false)
                .ForeignKey("Translation.TranslationOperation", t => t.TranslationOperationId,cascadeDelete: false)
                .Index(t => t.TranslatingOrderId)
                .Index(t => t.TranslationOperationId);
            
            CreateTable(
                "Order.TranslatingOrder",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TranslationDocumentId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("Sale.CampaignItem", t => t.CampaignItemId)
            ...
            CreateTable(
                "Order.TranslatingOrderTargetLanguage",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        TranslatingOrderId = c.Int(nullable: false),
            ...
            CreateTable(
                "Order.SimultaneousTranslatingOrderEquipment",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        SimultaneousTranslatingOrderId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("Common.Equipment", t => t.EquipmentId,cascadeDelete: false)
                .ForeignKey("Order.SimultaneousTranslatingOrder", t => t.SimultaneousTranslatingOrderId,cascadeDelete: false)
                .Index(t => t.SimultaneousTranslatingOrderId)
                .Index(t => t.EquipmentId);
            
            CreateTable(
                "Order.SimultaneousTranslatingOrder",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        CityId = c.Int(nullable: false),
                        ...
                        AccommodationProvided = c.Boolean(nullable: false),
                        FoodProvided = c.Boolean(nullable: false),
                        TransportationProvided = c.Boolean(nullable: false),
                        CustomerId = c.Int(nullable: false),
                        SourceLanguageId = c.Int(nullable: false),
                        TerminologyId = c.Int(nullable: false),
                        CompanyTerminologyId = c.Int(),
            ...
            CreateTable(
                "Order.SimultaneousTranslatingOrderTargetLanguage",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        SimultaneousTranslatingOrderId = c.Int(nullable: false),
            ...
            CreateTable(
                "Order.SimultaneousTranslatingOrderTranslator",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        SimultaneousTranslatingOrderId = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("Order.SimultaneousTranslatingOrderTranslator", "UserId", "System.User");
            DropForeignKey("Order.SimultaneousTranslatingOrderTranslator", "SimultaneousTranslatingOrderId", "Order.SimultaneousTranslatingOrder");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "TerminologyId", "Common.Terminology");
            DropForeignKey("Order.SimultaneousTranslatingOrderTargetLanguage", "SimultaneousTranslatingOrderId", "Order.SimultaneousTranslatingOrder");
            DropForeignKey("Order.SimultaneousTranslatingOrderTargetLanguage", "LanguageId", "Common.Language");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "SourceLanguageId", "Common.Language");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "OrderStatusId", "Common.OrderStatus");
            DropForeignKey("Order.SimultaneousTranslatingOrderEquipment", "SimultaneousTranslatingOrderId", "Order.SimultaneousTranslatingOrder");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "CustomerId", "Sale.Customer");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "CompanyTerminologyId", "Translation.CompanyTerminology");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "CityId", "Common.City");
            DropForeignKey("Order.SimultaneousTranslatingOrder", "CampaignItemId", "Sale.CampaignItem");
            DropForeignKey("Order.SimultaneousTranslatingOrderEquipment", "EquipmentId", "Common.Equipment");
            ...
            DropForeignKey("Order.TranslatingOrder", "TranslationQualityId", "Common.TranslationQuality");
            DropForeignKey("Order.TranslatingOrder", "TranslationDocumentId", "Document.TranslationDocument");
            DropForeignKey("Order.TranslatingOrder", "TerminologyId", "Common.Terminology");
            DropForeignKey("Order.TranslatingOrderTargetLanguage", "TranslatingOrderId", "Order.TranslatingOrder");
            DropForeignKey("Order.TranslatingOrderTargetLanguage", "LanguageId", "Common.Language");
            DropForeignKey("Order.TranslatingOrder", "SourceLanguageId", "Common.Language");
            DropForeignKey("Order.TranslatingOrder", "OrderStatusId", "Common.OrderStatus");
            DropForeignKey("Sale.OrderDetail", "TranslatingOrderId", "Order.TranslatingOrder");
            DropForeignKey("Order.TranslatingOrder", "CustomerId", "Sale.Customer");
            DropForeignKey("Order.TranslatingOrder", "CompanyTerminologyId", "Translation.CompanyTerminology");
            DropForeignKey("Order.TranslatingOrder", "CompanyDocumentTemplateId", "Translation.CompanyDocumentTemplate");
            DropForeignKey("Order.TranslatingOrder", "CampaignItemId", "Sale.CampaignItem");
            ...
            DropForeignKey("Sale.CompanyPriceOffer", "WorkingTypeId", "Common.WorkingType");
            ...
            DropForeignKey("System.AccountRegistration", "UserId", "System.User");
            ...
            DropIndex("Order.SimultaneousTranslatingOrderTranslator", new[] { "UserId" });
            DropIndex("Order.SimultaneousTranslatingOrderTranslator", new[] { "SimultaneousTranslatingOrderId" });
            DropIndex("Order.SimultaneousTranslatingOrderTargetLanguage", new[] { "LanguageId" });
            DropIndex("Order.SimultaneousTranslatingOrderTargetLanguage", new[] { "SimultaneousTranslatingOrderId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "CampaignItemId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "OrderStatusId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "CompanyTerminologyId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "TerminologyId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "SourceLanguageId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "CustomerId" });
            DropIndex("Order.SimultaneousTranslatingOrder", new[] { "CityId" });
            DropIndex("Order.SimultaneousTranslatingOrderEquipment", new[] { "EquipmentId" });
            DropIndex("Order.SimultaneousTranslatingOrderEquipment", new[] { "SimultaneousTranslatingOrderId" });
            DropIndex("Sale.PriceList", new[] { "TargetLanguageId" });
            DropIndex("Sale.PriceList", new[] { "SourceLanguageId" });
            DropIndex("Order.TranslatingOrderTargetLanguage", new[] { "LanguageId" });
            DropIndex("Order.TranslatingOrderTargetLanguage", new[] { "TranslatingOrderId" });
            DropIndex("Order.TranslatingOrder", new[] { "CampaignItemId" });
            DropIndex("Order.TranslatingOrder", new[] { "OrderStatusId" });
            DropIndex("Order.TranslatingOrder", new[] { "CompanyTerminologyId" });
            DropIndex("Order.TranslatingOrder", new[] { "TerminologyId" });
            DropIndex("Order.TranslatingOrder", new[] { "SourceLanguageId" });
            DropIndex("Order.TranslatingOrder", new[] { "CustomerId" });
            DropIndex("Order.TranslatingOrder", new[] { "TranslationQualityId" });
            DropIndex("Order.TranslatingOrder", new[] { "CompanyDocumentTemplateId" });
            DropIndex("Order.TranslatingOrder", new[] { "TranslationDocumentId" });
            DropIndex("Sale.OrderDetail", new[] { "TranslationOperationId" });
            DropIndex("Sale.OrderDetail", new[] { "TranslatingOrderId" });
            ...
            DropIndex("Sale.CompanyPriceOffer", new[] { "WorkingTypeId" });
            ...
            DropIndex("System.AccountRegistration", new[] { "UserId" });
            DropTable("System.UserLanguage");
            DropTable("Common.TerminologyPriceRate");
            DropTable("Translation.SourceTargetLanguage");
            DropTable("Order.SimultaneousTranslatingOrderTranslator");
            DropTable("Order.SimultaneousTranslatingOrderTargetLanguage");
            DropTable("Order.SimultaneousTranslatingOrder");
            DropTable("Order.SimultaneousTranslatingOrderEquipment");
            DropTable("Sale.PriceList");
            DropTable("Common.TranslationQuality");
            DropTable("Order.TranslatingOrderTargetLanguage");
            DropTable("Common.OrderStatus");
            DropTable("Order.TranslatingOrder");
            ...
            DropTable("System.AccountRegistration");
        }
    }
}
